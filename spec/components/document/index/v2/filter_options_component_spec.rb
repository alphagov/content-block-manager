RSpec.describe Document::Index::V2::FilterOptionsComponent, type: :component do
  ...
  before do
    ...
    allow(helper_mock).to receive(:v2_documents_path).and_return("path")
  ...
  it "adds the relevant GA4 data attributes" do
    ...
    expect(page).to have_css "form[data-ga4-search-url='#{helper_mock.v2_documents_path}']"
