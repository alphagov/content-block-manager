RSpec.describe FindAndReplaceEmbedCodesService do
  it "finds and replaces embed codes" do
    ...
    edition_1 = create(:edition, :pension, :published, document: document_1)
    document_1.latest_published_edition = edition_1
    document_1.save!

    document_2 = create(:document, :pension, content_id_alias: "something-else")
    edition_2 = create(:edition, :pension, :published, document: document_2)
    document_2.latest_published_edition = edition_2
    document_2.save!
