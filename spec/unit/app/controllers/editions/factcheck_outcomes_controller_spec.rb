RSpec.describe Editions::FactcheckOutcomesController, type: :controller do
  ...
  describe "GET to :review" do
    before do
      get :review, params: { id: 123 }
    end
    ...
    it "renders the editions/factcheck_outcomes/review template" do
      expect(response).to have_rendered("editions/factcheck_outcomes/review")
    end
  end
  ...
  describe "PUT to :update" do
    ...
    context "when the edition is due to be scheduled" do
      ...
      it "shows a success message" do
        expected_success_message = "Edition has been moved into state 'Scheduled'"
    ...
    context "when the edition is NOT due to be scheduled" do
      ...
      it "shows a success message" do
        expected_success_message = "Edition has been moved into state 'Published'"
        expect(flash.notice).to eq(expected_success_message)
      end
    end
