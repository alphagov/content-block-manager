RSpec.describe ProcessedParams do
  ...
  context "when there is a date field" do
    ...
    context "when the days/months are empty" do
      let(:params) do
        {
          "block_type" => {
            "published_at(1i)" => "",
    ...
    context "when the days/months contain non numeric values" do
      let(:params) do
        {
          "block_type" => {
            "published_at(1i)" => "A",
      ...
      it "separates the values with dashes and does not pad" do
        expect(processed_params.result).to eq({
          "block_type" => {
            "published_at" => "A-B-C",
          },
