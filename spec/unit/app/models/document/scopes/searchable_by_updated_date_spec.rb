RSpec.describe Document::Scopes::SearchableByUpdatedDate do
  describe ".last_updated_after" do
    it "finds documents updated from and including this date" do
      ...
      latest_edition_1 = create(:edition, :pension, :latest, document: matching_document_1, updated_at: filter_date_time)
      ...
      latest_edition_2 = create(:edition, :pension, :latest, document: matching_document_2, updated_at: Time.zone.now)
  ...
  describe ".last_updated_before" do
    it "finds documents updated up to and including this date" do
      ...
      latest_edition_2 = create(:edition, :pension, :latest, document: matching_document_2, updated_at: filter_date_time)
      matching_document_2.latest_edition = latest_edition_2
      matching_document_2.save!
