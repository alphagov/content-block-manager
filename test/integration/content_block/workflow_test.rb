...
class ContentBlockManager::ContentBlock::WorkflowTest < ActionDispatch::IntegrationTest
    ...
    describe "when on the edit step" do
      ...
      describe "#show" do
        it "shows the correct title and back link" do
          get content_block_manager_content_block_workflow_path(id: edition.id, step:)

          assert_equal assigns(:title), "Create #{schema.name}"
          assert_equal assigns(:back_path), new_content_block_manager_content_block_document_path
        end
      end
    end
    ...
    describe "when reviewing the changes" do
      ...
      describe "#show" do
        ...
        it "shows the correct context and confirmation text" do
          visit content_block_manager_content_block_workflow_path(id: edition.id, step:)
      ...
      describe "#update" do
        it "posts the new edition to the Publishing API and marks edition as published" do
          assert_edition_is_published do
            put content_block_manager_content_block_workflow_path(id: edition.id, step:, is_confirmed: true)
          end
        end
      end
    end
    ...
    describe "when the edition details have not been confirmed" do
      ...
      describe "#update" do
        it "returns to the review page" do
          put content_block_manager_content_block_workflow_path(id: edition.id, step:)
    ...
    describe "when subschemas are present" do
      ...
      describe "#show" do
        it "shows the form for the first subschema" do
          get content_block_manager_content_block_workflow_path(id: edition.id, step: "embedded_subschema_1")
        ...
        it "shows the form for the second subschema" do
          get content_block_manager_content_block_workflow_path(id: edition.id, step: "embedded_subschema_2")
      ...
      describe "#update" do
        it "redirects to the second subschema" do
          put content_block_manager_content_block_workflow_path(id: edition.id, step: "embedded_subschema_1")

          assert_redirected_to content_block_manager_content_block_workflow_path(id: edition.id, step: :embedded_subschema_2)
        end

        it "redirects to the review page" do
          put content_block_manager_content_block_workflow_path(id: edition.id, step: "embedded_subschema_2")
    ...
    describe "when editing an existing edition" do
      ...
      describe "#show" do
        ...
        it "shows the correct title and back link" do
          ...
          assert_equal assigns(:back_path), content_block_manager_content_block_document_path(document)
        end
      end
        ...
        describe "when there is no embedded content" do
          ...
          describe "when the request comes from the next step" do
            it "redirects to the previous step" do
              get content_block_manager_content_block_workflow_path(id: edition.id, step:),
                  headers: { "HTTP_REFERER" => "http://example.com#{content_block_manager_content_block_workflow_path(id: edition.id, step: :internal_note)}" }
    ...
    describe "when updating the change note" do
      ...
      describe "when subschemas are present" do
        ...
        describe "when the subschemas are in a group" do
          ...
          describe "#show" do
            describe "when content exists for at least some of the subschemas" do
              ...
              it "shows the form for the group" do
                get content_block_manager_content_block_workflow_path(id: edition.id, step: "group_some_group")
          ...
          describe "#update" do
            it "redirects to review links" do
              put content_block_manager_content_block_workflow_path(id: edition.id, step: "group_some_group")
      ...
      describe "#update" do
        ...
        describe "when scheduling publication" do
          it "redirects to the internal note page" do
            ...
            put content_block_manager_content_block_workflow_path(id: edition.id, step:), params: {
  ...
  describe "when an unknown step is provided" do
    describe "#show" do
      it "shows the new edition for review" do
        get content_block_manager_content_block_workflow_path(id: edition.id, step: "some_random_step")
    ...
    describe "#update" do
      it "posts the new edition to the Publishing API and marks edition as published" do
        put content_block_manager_content_block_workflow_path(id: edition.id, step: "some_random_step")
  ...
  describe "when an unknown subschema step is provided" do
    describe "#show" do
      it "returns a 404" do
        get content_block_manager_content_block_workflow_path(id: edition.id, step: "embedded_something")
  ...
  describe "when an unknown group step is provided" do
    describe "#show" do
      it "returns a 404" do
        get content_block_manager_content_block_workflow_path(id: edition.id, step: "group_something")
