...
class ContentBlockManager::ContentBlock::Editions::EmbeddedObjectsTest < ActionDispatch::IntegrationTest
  ...
  describe "#new" do
    describe "when an object type is provided" do
      it "fetches the subschema and renders the template" do
        get new_embedded_object_content_block_manager_content_block_edition_path(
          edition,
          object_type,
        )
    ...
    describe "when no object type is provided" do
      describe "when a group is provided" do
        it "renders a list of subschemas for the group" do
          ...
          assert_equal assigns(:back_link), content_block_manager_content_block_workflow_path(
            edition,
            step: "group_#{group}",
          )
          assert_equal assigns(:redirect_path), new_embedded_objects_options_redirect_content_block_manager_content_block_edition_path(edition)
  ...
  describe "#new_embedded_objects_options_redirect" do
    describe "when the object_type param is provided" do
      before do
        post new_embedded_objects_options_redirect_content_block_manager_content_block_edition_path(
          edition,
      ...
      it "redirects to the path for that object" do
        assert_redirected_to new_embedded_object_content_block_manager_content_block_edition_path(edition, object_type: "something")
      end

      it "sets the back link as a flash" do
        assert_equal new_embedded_objects_options_redirect_content_block_manager_content_block_edition_path(
          edition,
          group: "something",
        ), flash[:back_link]
      end
    ...
    describe "when the object_type param is not provided" do
      it "redirects back to the schema select page with an error" do
        ...
        assert_redirected_to new_embedded_object_content_block_manager_content_block_edition_path(
          edition,
          group: "something",
        )
  ...
  describe "#create" do
    it "should create an embedded object for an edition" do
      post create_embedded_object_content_block_manager_content_block_edition_path(
        edition,
        object_type:,
      ), params: {
      ...
      assert_redirected_to content_block_manager_content_block_workflow_path(
  ...
  describe "#edit" do
    it "should fetch an object of a particular type" do
      get edit_embedded_object_content_block_manager_content_block_edition_path(
        edition,
        object_type:,
  ...
  describe "#update" do
    it "should update an embedded object for an edition" do
      put embedded_object_content_block_manager_content_block_edition_path(
        edition,
        object_type:,
        object_title: "embedded",
      ), params: {
      ...
      assert_redirected_to review_embedded_object_content_block_manager_content_block_edition_path(
        edition,
        object_type:,
        object_title: "embedded",
      )
    ...
    it "should redirect if a redirect_url is given" do
      put embedded_object_content_block_manager_content_block_edition_path(
        ...
        redirect_url: content_block_manager_content_block_documents_path,
        "content_block/edition" => {
          details: {
            object_type => {
              "title" => "Embedded",
      ...
      assert_redirected_to content_block_manager_content_block_documents_path
