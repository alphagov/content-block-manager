...
class ContentBlockManager::ContentBlock::Edition::Details::Fields::CountryComponentTest < ViewComponent::TestCase
  ...
  it "should render an select field populated with WorldLocations with the UK as the blank option" do
    render_inline(
      ContentBlockManager::ContentBlock::Edition::Details::Fields::CountryComponent.new(
    ...
    expected_id = "#{ContentBlockManager::ContentBlock::Edition::Details::Fields::BaseComponent::PARENT_CLASS}_details_country"
  ...
  describe "#options" do
    it "returns a list of countries" do
      component = ContentBlockManager::ContentBlock::Edition::Details::Fields::CountryComponent.new(
        content_block_edition:,
        field:,
      )
