...
class Document::Show::DocumentTimelineComponentTest < ViewComponent::TestCase
  ...
  it "renders components for each event" do
    ...
    component = Document::Show::DocumentTimelineComponent.new(
    ...
    Document::Show::DocumentTimeline::TimelineItemComponent
      .expects(:new)
      .with(
        version: version_4,
        schema:,
