...
class Document::Show::DocumentTimeline::EmbeddedObject::FieldChangesTableComponentTest < ViewComponent::TestCase
  ...
  it "renders the edition diff table" do
    render_inline(
      Document::Show::DocumentTimeline::EmbeddedObject::FieldChangesTableComponent.new(
        object_id: "something",
        field_diff:,
