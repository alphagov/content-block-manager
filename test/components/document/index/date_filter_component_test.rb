...
class Document::Index::DateFilterComponentTest < ViewComponent::TestCase
  extend Minitest::Spec::DSL

  it "renders from and to dates" do
    render_inline(Document::Index::DateFilterComponent.new)
  ...
  it "keeps the values from the filter params" do
    ...
    render_inline(Document::Index::DateFilterComponent.new(filters:))
  ...
  it "renders errors if there are errors on the date filter" do
    ...
    render_inline(Document::Index::DateFilterComponent.new(errors:))
