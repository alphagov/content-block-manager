  ...
  describe "date validation" do
    ...
    %i[last_updated_from last_updated_to].each do |attribute|
      describe "when #{attribute} contains non-date values" do
        ...
        it "returns errors" do
          ...
          assert_equal errors.first.full_message, I18n.t("document.index.errors.date.invalid", attribute: attribute.to_s.humanize)
        end
      end
    ...
    describe "when last_updated_from is after last_updated_to" do
      ...
      it "returns errors" do
        ...
        assert_equal errors.first.full_message, I18n.t("document.index.errors.date.range.invalid")
      end
    end
  end
end
