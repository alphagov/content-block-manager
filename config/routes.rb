Rails.application.routes.draw do
  ...
  resources :editions, only: %i[new create destroy], path_names: { new: ":block_type/new" } do
    member do
      ...
      get "fact_check_outcomes/new", to: "editions/factcheck_outcomes#new", as: :new_factcheck_outcome
      post "fact_check_outcomes", to: "editions/factcheck_outcomes#create", as: :create_factcheck_outcome
      get "fact_check_outcomes/identify_performer", to: "editions/factcheck_outcomes#identify_performer", as: :identify_performer_factcheck_outcome
      put "fact_check_outcomes", to: "editions/factcheck_outcomes#update", as: :update_factcheck_outcome
